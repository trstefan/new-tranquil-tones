...
const HeroSection = () => {
  return (
    <section className="text-center mb-24 md:mb-40 flex flex-col items-center">
      <p className="text-moss-400 font-outfit text-base  md:text-base tracking-[0.2em]  mb-6 md:mb-8 animate-slide-up">
        A breath of fresh air for your mind
      </p>

      <h1 className="text-4xl sm:text-7xl md:text-[9rem] font-serif italic text-moss-100 leading-[0.9] md:leading-[0.85] mb-8 md:mb-12 animate-slide-up [animation-delay:200ms]">
        Find your <br />
      ...
      <div className="max-w-xl mx-auto animate-slide-up [animation-delay:400ms] px-4">
        <p className="text-moss-300 font-light text-lg md:text-xl leading-relaxed mb-10 md:mb-12">
          Escape the digital noise. Layer the organic textures of the earth to
          create a workspace that feels like a hidden forest.
        </p>
