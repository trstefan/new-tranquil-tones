...
export const SanctuaryHeader = ({
  ...
  return (
    <header className="md:fixed top-0 left-0 right-0 z-40 bg-stone-950/40 backdrop-blur-xl border-b border-white/5 ">
      <div className="max-w-350 mx-auto p-6 md:px-10 h-20 md:h-24 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="text-left">
              <h1 className="text-base md:text-lg font-outfit font-medium tracking-widest uppercase text-moss-100">
                Tranquil Tones
              </h1>
              <p className="text-[8px] md:text-[9px] text-moss-500 uppercase tracking-[0.3em] font-bold">
                Sanctuary
              </p>
            </div>
          </Link>
