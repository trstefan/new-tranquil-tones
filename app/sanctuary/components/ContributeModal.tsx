      ...
      <div className="relative w-full max-w-lg md:max-w-2xl bg-stone-900/90 border border-white/10 rounded-[2.5rem] md:rounded-[3.5rem] shadow-3xl overflow-hidden animate-slide-up flex flex-col max-h-[90vh]">
        ...
        <div className="relative z-10 p-6 md:p-10 overflow-y-auto custom-scrollbar">
          ...
          <header className="mb-6 pr-8">
            ...
            <h2 id="modal-title" className="text-2xl md:text-4xl font-serif italic text-moss-100 leading-tight">
              Contribute to <br className="sm:hidden" /><span className="text-moss-500 not-italic">Tranquil Tones</span>
            </h2>
          </header>
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-4 md:space-y-6">
              <p className="text-moss-500 text-[10px] md:text-xs uppercase tracking-[0.3em] font-bold">A few ways you can help:</p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="text-moss-100 font-medium text-sm md:text-base">Send an email directly to <a href="mailto:hello@tranquiltones.app" className="text-moss-400 hover:text-moss-200 underline decoration-moss-500/30 underline-offset-4 transition-all">me</a></p>
                    <p className="text-moss-500 text-xs md:text-sm mt-1">Suggest new field recordings or report a bug.</p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="text-moss-100 font-medium text-sm md:text-base">Contribute code to <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-moss-400 hover:text-moss-200 underline decoration-moss-500/30 underline-offset-4 transition-all inline-flex items-center gap-1">Tranquil Tones <ExternalLink className="w-3 h-3" /></a></p>
                    <p className="text-moss-500 text-xs md:text-sm mt-1">Join our open source sanctuary via GitHub.</p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="text-moss-100 font-medium text-sm md:text-base">Like this project? <span className="text-moss-400">Give it a star.</span></p>
                    <p className="text-moss-500 text-xs md:text-sm mt-1">Spread the word and help us reach more quiet minds.</p>
                  </div>
                </li>
              </ul>
            </div>
